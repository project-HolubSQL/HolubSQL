...
public class HTMLExporterTest {
  ...
  public void HTML() throws IOException {
    ...
    assertThat(stringBuffer.toString(), is(equalTo(
        "<html><body>people<table border=\"1\"><th>First</th><th>Last</th><th>Id</th><tr><td>Allen</td><td>Holub</td>" +
    ...
    assertThat(stringBuffer1.toString(), is(equalTo(
        "<html><body>people<table border=\"1\" bordercolor=\"blue\"><th>First</th><th>Last</th><th>Id</th><tr><td>Allen</td><td>Holub</td>"
            +
            "<td>1</td></tr><tr><td>Ichabod</td><td>Crane</td><td>2</td></tr><tr><td>Rip</td><td>VanWinkle</td><td>3</td></tr><tr><td>Goldie</td><td>Locks</td><td>4</td></tr></table></body></html>")));
    ...
    assertThat(stringBuffer2.toString(), is(equalTo(
        "<html><body>university<table border=\"1\"><th>name</th><th>location</th><tr><td>chungang</td><td>seoul</td></tr><tr><td>seoul</td><td>seoul</td>"
            +
    ...
    assertThat(stringBuffer3.toString(), is(equalTo(
        "<html><body>university<table border=\"1\"><th>name</th><th>location</th><tr><td>chungang</td><td>seoul</td></tr><tr>"
            +
