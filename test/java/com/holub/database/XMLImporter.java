...
// public class XMLImporterTest { // 반드시 XMLExporterTest진행후 xml형식의 해당 파일이 만들어진
// 상태에서 테스트 해야함 . HTMLExporterTest 직후에
// // 테스트하면 해당 파일내용이 html형식이라 오류발생
// @Test
// public void XMLImporter() throws IOException, ParserConfigurationException,
// SAXException {
...
// String[][] expected = { { "Allen", "Holub", "1" }, { "Ichabod", "Crane", "2"
// }, { "Rip", "VanWinkle", "3" },
// { "Goldie", "Locks", "4" } };
...
// String[][] expected2 = { { "chungang", "seoul" }, { "seoul", "seoul" }, {
// "woosong", "daejeon" } };
