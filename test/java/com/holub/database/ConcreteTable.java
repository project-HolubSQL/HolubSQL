...
// Table people = TableFactory.create("name", new String[] { "wfirst", "last",
// "addrId" });
// Table address = TableFactory.create("address", new String[] { "addrId",
...
// Table importedTable = new ConcreteTable(new XMLImporter(new
...
// setData();
// String query = " select * from address, name where address.addrId =
// name.addrId";
...
// setData();
// String query = "select * from (select * from address, name where
// address.addrId = name.addrId) where addrId=1";
// Table result = database.execute(query);
// String expected = "<anonymous>\n" +
// "addrId\tstreet\tcity\tstate\tzip\tfirst\tlast\t\n" +
// "----------------------------------------\n" +
