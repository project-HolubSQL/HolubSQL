 ...
 * <p>
 * See the source code for {@link com.designpattern.database.Database}
 ...
 * 
 * private static final Token COMMA = tokens.create("',"),
 * 		EQUAL = tokens.create("'="),
 * 		LP = tokens.create("'("),
 * 		RP = tokens.create("')"),
 * 		DOT = tokens.create("'."),
...
public class Scanner {
	...
	public Scanner(TokenSet tokens, Reader inputReader) {
		this.tokens = tokens;
		this.inputReader = (inputReader instanceof BufferedReader)
