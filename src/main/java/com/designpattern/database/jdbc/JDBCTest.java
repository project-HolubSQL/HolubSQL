...
public class JDBCTest {
	static String[] data = { "(1,  'John',   'Mon', 1, 'JustJoe')",
			"(2,  'JS',     'Mon', 1, 'Cappuccino')",
			"(3,  'Marie',  'Mon', 2, 'CaffeMocha')",
	};

	public static void main(String[] args) throws Exception {
		Class.forName("com.designpattern.database.jdbc.JDBCDriver") // {=JDBCTest.forName}
				.newInstance();
		...
		try {
			...
			while (result.next()) {
				System.out.println(result.getInt("Entry") + ", "
