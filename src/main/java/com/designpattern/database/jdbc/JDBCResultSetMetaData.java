 ...
 *    in any of this code.
 */
package com.designpattern.database.jdbc;

import java.sql.*;
import java.util.*;

import com.designpattern.database.*;
import com.designpattern.database.jdbc.adapters.*;
...
public class JDBCResultSetMetaData extends ResultSetMetaDataAdapter {
	...
	public String getColumnName(int index) throws java.sql.SQLException { // The Cursor is zero indexed, which makes sense
																																				// from a Java
																																				// perspective. JDBC is 1 indexed, however; thus
																																				// the -1.
